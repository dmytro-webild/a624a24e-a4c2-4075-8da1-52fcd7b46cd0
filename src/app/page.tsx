...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/fish-slices-with-herbs-sliced-lemon_140725-3606.jpg",
          imageAlt: "Bite&Bottle Dining Experience",
        },
        {
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/fried-vegetables-with-cheese-table_140725-8569.jpg",
          imageAlt: "Takeaway Meal Selection",
        },
        {
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          handle: "@sarahkigali",
          testimonial: "The reservation process was seamless, and the meal was spectacular. Highly recommend!",
        ...
        },
        {
          ...
          name: "Mark D.",
          handle: "@markfoodie",
          testimonial: "My go-to spot for business dinners in Kigali. The service and food are unmatched.",
        ...
        },
        {
          ...
          name: "Elena R.",
          handle: "@elenaeat",
          testimonial: "Absolutely love the delivery tracking—my meal arrived hot and perfectly plated.",
        ...
        },
        {
          ...
          name: "Joseph B.",
          handle: "@josephrw",
          testimonial: "Authentic flavors and a welcoming atmosphere. My favorite spot in the city.",
        ...
        },
        {
          ...
          name: "Amara K.",
          handle: "@amarakigali",
          testimonial: "Top-notch experience from reservation to the last bite of dessert.",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "1",
          title: "Do you deliver throughout Kigali?",
          content: "Yes, we offer city-wide delivery within a 15km radius of our location.",
        },
        {
          id: "2",
          title: "What payment methods do you accept?",
          content: "We accept Mobile Money, debit cards, and cash on delivery for orders.",
        },
        {
          id: "3",
          title: "How far in advance should I reserve?",
          content: "We recommend reserving at least 24 hours in advance for weekend bookings.",
        },
      ]}
